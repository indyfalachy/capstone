<form wire:submit.prevent="create">
    <x-form.select model="queue.patient_id" title="Nama pasien" :options="$optionPatient"
                   :selected="$queue['patient_id']" defer="true"/>
    <x-form.select model="queue.unit_service_id" title="Nama unit layanan" :options="$optionUnit"
                   :selected="$queue['unit_service_id']" defer="true"/>
